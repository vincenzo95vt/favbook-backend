 ...
 * /posts/{id}:
 *   delete:
 *     summary: Elimina una foto por su ID
 *     description: Elimina una foto existente de la colección utilizando su ID.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 *         description: ID de la foto que se va a eliminar.
 *         schema:
 *           type: string
 *     responses:
 *       '200':
 ...
 *       '404':
 *         description: No se encuentra la foto con el ID especificado.
 *       '400':
